...
class UnicodeTables {
  ...
  private static _DELTA_CATEGORIES = /*#__PURE__*/ new LazyDecoder<Uint32Array>({
    ...
    S: () =>
      decodeRanges('nhJCBz+CDBlPBBK-82B-82BBxzvBxzvBBuHBRzNB-vKJBFBBoOGGvBIIWDDKiHiHBjBB', false),
  ...
  private static _DELTA_SCRIPTS = /*#__PURE__*/ new LazyDecoder<Uint32Array>({
    ...
    Common: () =>
      decodeRanges('nhJCBz+CDBlPBBKxwmDxwmDB4HBHzNB-vKJBFBBoOGGvBIIWDDKiHiHBjBB', false),
  ...
  static buildForProperty(name: string): UnicodeRangeTable | null {
    ...
    const delta =
      kind === 'category' ? this._DELTA_CATEGORIES.get(name) : this._DELTA_SCRIPTS.get(name)
