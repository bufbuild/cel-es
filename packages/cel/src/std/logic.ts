...
const ltFunc = celFunc(Operator.LESS, [
  ...
  celOverload([CelScalar.INT, CelScalar.UINT], CelScalar.BOOL, (l, r) => l < r.value, [CelOverloadFlags.CROSS_TYPE_NUMERIC_COMPARISON]),
  celOverload([CelScalar.UINT, CelScalar.INT], CelScalar.BOOL, (l, r) => l.value < r, [CelOverloadFlags.CROSS_TYPE_NUMERIC_COMPARISON]),
  ...
  celOverload([CelScalar.INT, CelScalar.DOUBLE], CelScalar.BOOL, (l, r) => Number(l) < r, [CelOverloadFlags.CROSS_TYPE_NUMERIC_COMPARISON]),
  celOverload([CelScalar.DOUBLE, CelScalar.INT], CelScalar.BOOL, (l, r) => l < Number(r), [CelOverloadFlags.CROSS_TYPE_NUMERIC_COMPARISON]),
  celOverload([CelScalar.DOUBLE, CelScalar.UINT], CelScalar.BOOL, (l, r) => l < Number(r.value), [CelOverloadFlags.CROSS_TYPE_NUMERIC_COMPARISON]),
  celOverload([CelScalar.UINT, CelScalar.DOUBLE], CelScalar.BOOL, (l, r) => Number(l.value) < r, [CelOverloadFlags.CROSS_TYPE_NUMERIC_COMPARISON]),
